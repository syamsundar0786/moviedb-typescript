...
import { HomeProp, ReqRes } from "@/interface/interface";



export default function Home({ data, search }:HomeProp) {
...
export async function getServerSideProps({ req, res }:ReqRes) {
  try {
    const routeApi = await fetch(`https://api.themoviedb.org/3/trending/movie/day?api_key=6e37d364da090a453e6c12697bcfcde7&page=1`);
